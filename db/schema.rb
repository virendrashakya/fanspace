...
ActiveRecord::Schema[7.0].define(version: 2022_12_28_095809) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["influencer_id"], name: "index_posts_on_influencer_id"
  end
  ...
  create_table "social_accounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["influencer_id"], name: "index_social_accounts_on_influencer_id"
  end
  ...
  add_foreign_key "profiles", "influencers"
  add_foreign_key "social_accounts", "influencers"
end
