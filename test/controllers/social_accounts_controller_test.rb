...
class SocialAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_account" do
    assert_difference("SocialAccount.count") do
      post social_accounts_url, params: { social_account: { icon: @social_account.icon, influencer_id: @social_account.influencer_id, public_url: @social_account.public_url } }
    end
  ...
  test "should update social_account" do
    patch social_account_url(@social_account), params: { social_account: { icon: @social_account.icon, influencer_id: @social_account.influencer_id, public_url: @social_account.public_url } }
